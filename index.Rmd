---
title: "A retrospective analysis of historical data from multi-environment trial evaluation for dry bean (*Phaseolus vulgaris*) in Michigan"
...
This is the supplemental material for the manuscript **A retrospective analysis of historical data from multi-environment trial evaluation for dry bean** *(Phaseolus vulgaris)* **in Michigan.**
...
print_table(data_beans_S1, caption = "Supplementary Table S1: Code, commercial names, market class, release year, yield and maturity range observed in the trials of the dry beans cultivars used in the study.")
...
kable(data_beans_S1, align = "c", booktabs = T, format = "latex", 
      linesep = "", longtable = TRUE,
       caption = "Supplementary Table S1: Code, commercial names, market class, release year, yield and maturity range observed in the trials of the dry beans cultivars used in the study.") %>%
