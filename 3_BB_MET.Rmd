...
mod.met.asreml.bb<- data.table((mod.met.asreml.bb1$predictions$pvals[1:3]))
...
```{r bb gge fig1, warning=FALSE, message=FALSE, fig.heiht=figheight, fig.width=figwidth, fig.align="center", dpi = 600}
...
```{r bb gge fig2, warning=FALSE, message=FALSE, fig.heiht=figheight, fig.width=figwidth, fig.align="center", dpi = 600}
gge_model.bb <- gge(blues_stage.I_BB, loc, name, yield,
                     centering = "environment", #2
                    scaling = "sd", #1
                    svp = "genotype")#2)
...
```{r mod metan bb stab, warning=FALSE, message=FALSE, fig.heiht=figheight, fig.width=figwidth, fig.align="center", dpi = 600}
...
```{r mod metan bb stab6, warning=FALSE, message=FALSE, fig.heiht=figheight, fig.width=figwidth, fig.align="center", dpi = 600}
...
```{r mod metan bb stab7, warning=FALSE, message=FALSE, fig.heiht=figheight, fig.width=figwidth, fig.align="center", dpi = 600}
