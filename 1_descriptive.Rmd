...
```{r Box plot_raw data complete, eval= FALSE, warning=FALSE, message=FALSE, fig.height=figheight, fig.width=figwidth, dpi = 600, out.width="100%"}
...
```{r Box plot_raw data, eval=TRUE, fig.height=figheight, fig.width=figwidth, message=FALSE, warning=FALSE, dpi=600, out.width="100%"}
...
```{r plot_Box complete final, warning=FALSE, message=FALSE, fig.height=figheight, fig.width=figwidth, dpi = 600, out.width="100%"}
...
-   Combination analysis across all market classes (Comb_MKT) 
-   **Pairwise Games-Howell test used. Comparisons showing significant values only**

```{r plot_ggstatsplot_desc_all_mkt, warning=FALSE, message=FALSE, fig.height=figheight, fig.width=figwidth, dpi = 600, out.width="100%"}
plotDM_stats_mkt_loc_all<- grouped_ggbetweenstats(data=data_beans, x= loc, y=gy_kg_ha, type = "parametric", 
                                                  bf.message = F, results.subtitle = F,
ylab= "GY", xlab = "Locations", plot.type = "boxviolin", grouping.var = year )

print(plotDM_stats_mkt_loc_all)
...
```{r plot_ggstatsplot_desc_BB, warning=FALSE, message=FALSE, fig.height=figheight, fig.width=figwidth, dpi = 600, out.width="100%"}
data_beans_plotBB<- droplevels(subset(data_beans, mkt=="BB"))
...
```{r plot_ggstatsplot_desc_NB, warning=FALSE, message=FALSE, fig.height=figheight, fig.width=figwidth, dpi = 600, out.width="100%"}
...
```{r plot_ggstatsplot_desc_SR, warning=FALSE, message=FALSE, fig.height=figheight, fig.width=figwidth, dpi = 600, out.width="100%"}
...
```{r TDscatter2, warning=FALSE, out.width="100%", message=FALSE, fig.height=figheight, fig.width=figwidth, fig.align="center", dpi = 600}
...
- No outliers removed after the data inspection based on Breeder's expertise.

### Map of locations 

```{r message=FALSE, warning=FALSE, include=FALSE}
source("utils/map_fig1.R")
```


```{r combined_plot1, warning=FALSE, out.width="100%", message=FALSE, fig.height=figheight, fig.width=figwidth, fig.align="center", dpi = 600, fig.pos="H", fig.cap= "Historical dry beans production in tons across years for black beans (BB), navy beans (NB) and small red beans (SR)."}
...
```{r combined_plot2, warning=FALSE, out.width="100%", message=FALSE, fig.height=figheight, fig.width=figwidth, fig.align="center", dpi = 600, fig.pos="H", fig.cap= "Counties locations evaluated in this study at Michigan, mid-west in the USA. For each MI county, the blue scale shows the last year of data available."}
...
```{r missing geno gy, warning=FALSE, message=FALSE, out.width="100%", fig.pos="H", fig.align="center", dpi = 600, fig.cap="Missing genotypes by beans market classes"}
...
knitr::include_graphics(here::here("figures", "coincidence geno fig1-1.png"))
